...
latex_documents = [
    (master_doc, 'ripser.tex', u'Ripser.py Documentation',
...
man_pages = [
    (master_doc, 'ripser.py', u'Ripser.py Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ripser.py', u'Ripser.py Documentation',
     author, 'Ripser.py', 'A Lean Persistent Homology Library for Python'),
]
